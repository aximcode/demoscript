/**
 * SequenceDiagramMermaid - Renders Mermaid sequence diagrams with step highlighting
 * Uses CSS styling to highlight the current message/interaction
 * NOTE: This is the legacy Mermaid-based implementation, kept for fallback
 */
...
export function SequenceDiagramMermaid({
  chart,
  currentPath,
  completedPaths = [],
  height = 300,
