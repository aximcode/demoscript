  ...
  return (
    <GlowingCard isActive={status === 'complete'} color="emerald" intensity="medium">
      <div className="bg-white/90 dark:bg-slate-800/80 backdrop-blur-sm rounded-xl shadow-md dark:shadow-xl border border-gray-200 dark:border-emerald-500/20 overflow-hidden transition-colors duration-300">
        ...
        {/* Play button and Reset */}
        <div className="p-4 border-t border-gray-200 dark:border-slate-700/50">
          <div className="flex items-center gap-3">
            <button
              onClick={playAnimation}
              disabled={isPlaying}
              className="px-6 py-2.5 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-medium rounded-lg hover:from-emerald-400 hover:to-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-emerald-500/25 transition-all duration-300 flex items-center gap-2"
            >
              {isPlaying ? (
                <>
            ...
            {status === 'complete' && (
              <button
                ...
                disabled={isPlaying}
                className="px-4 py-2.5 bg-gray-500 text-white font-medium rounded-lg hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg transition-all duration-300 flex items-center gap-2"
              >
